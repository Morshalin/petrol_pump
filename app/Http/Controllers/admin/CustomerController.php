...
class CustomerController extends Controller
{
   ...
   $validatedData = $request->validate([
      ...
      return response()->json(['success' => true, 'status' => 'success', 'message' => _lang('Customer Information Successfuly'), 'goto' => route('admin.customer.index')]);
    }
    ...
    public function destroy($id){
       $model = Customer::findOrFail($id);
        $model->delete();
       return response()->json(['success' => true, 'status' => 'success', 'message' => _lang('Customer Delete  Successfuly'), 'goto' => route('admin.customer.index')]);
    }
}
