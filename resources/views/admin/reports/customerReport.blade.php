@extends('layouts.app', ['title' => _lang('Customer Sale Report')])
@section('content')
<!-- Basic initialization -->
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300 d-print-none">
		<h5 class="card-title">{{_lang('Customer Sale Report')}}
		</h5>
    ...
    <div class="container d-print-none">
        <div class="row">
            <div class="col-sm-12">
                <p class="text-center text-info h4">Customer Sale Report</p>
            </div>
            <div class="col-sm-8 form-control offset-2 mb-3">
				...
				<div class="col-sm-6">
                    <div class="form-group">
						<label for="customer_id" class="form-check-label">customer Name</label>
						<select name="customer_id" data-placeholder="Select One" id="customer_id" class="form-control select">
