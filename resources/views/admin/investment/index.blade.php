...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{_lang('Investment')}}
		@can('user.create')
						...
						<div class="list-icons">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="{{ route('admin.investment.edit', $data->id) }}" class="dropdown-item"><i class="icon-pencil7"></i> Edit</a>.
									<span data-id="{{$data->id}} " data-url="{{route('admin.investment.destroy',$data->id)}} " class="dropdown-item" id="delete_item"><i class="icon-cross2"></i> Delete</span>
