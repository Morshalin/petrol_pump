@extends('layouts.app', ['title' => _lang('Withdraw manage')])
@section('page.header')
<div class="page-header page-header-light">
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                <span class="breadcrumb-item active"><i class="icon-home2 mr-2"></i>Amount Widthdraw</span>
            </div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		...
		<h5 class="card-title">{{_lang('Withdraw manage')}}
		</h5>
    ...
    <fieldset class="mb-3" id="form_field">
    	<form action="{{route('admin.withdraw')}}" method="post" id="content_form">
		@csrf
	     <div class="row">
	     	<div class="col-md-6">
			 ...
			 <div class="col-md-6">
				<div class="form-group">
					...
					<select data-placeholder="Select One" name="expense_category_id" id="expense_category_id" class="form-control select">
						<option value="">Select One</option>
							@foreach ($expense_type as $expense_item)
			 ...
			 <input type="hidden" name="acc_type" value="Debit">
