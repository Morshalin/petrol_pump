@extends('layouts.app', ['title' => 'Product', 'modal' => true])
@section('page.header')
<div class="page-header page-header-light">
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				<span class="breadcrumb-item active"><i class="icon-home2 mr-2"></i>Product</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{_lang('Add New Product')}}
			...
			<a href="{{ route('admin.product.create') }}" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i>{{_lang('Create')}} </a>
		</h5>
		...
		<table class="table content_managment_table">
			<thead>
				<tr> 
					...
					<th>{{_lang('Vehicel Name')}}</th>
					<th>{{_lang('Oil Stack')}}</th>
