	...
	<div class="row">
		<div class="col-sm-6 offset-3">
			...
			<fieldset class="mb-3" id="form_field">
				<form action="{{route('admin.post.update', $model->id)}}" method="post" id="content_form">
				@csrf
				@method('PUT');
				<div class="row">
					<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" value="{{$model->post_name}}" class="form-control" name="post_name" id="post_name">
					</div>
					</div>
				</div>
