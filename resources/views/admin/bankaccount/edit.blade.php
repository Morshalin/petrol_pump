...
<div class="card border-top-success rounded-top-0" id="table_card">
    ...
    <fieldset class="mb-3" id="form_field">
    	<form action="{{route('admin.bankaccount.update',$model->id)}}" method="post" id="content_form">
		@csrf
		@method('PUT')
	     <div class="row">
	     	<div class="col-md-6">
	     	  <div class="form-group">
	     	  	...
	     	  	<input type="text" class="form-control" name="acc_name" id="acc_name" value="{{$model->acc_name}}">
	          </div>
	     	</div>
	     	...
	     	<div class="col-md-6">
	     	  <div class="form-group">
	        	...
	        	<input type="text" class="form-control" value="{{$model->acc_no}}" name="acc_no" id="acc_no">
	          </div>
	     	</div>
	     	...
	     	<div class="col-md-6">
	     	  <div class="form-group">
	        	...
	        	<input type="text" class="form-control" name="contact_persion" value="{{$model->contact_persion}}" id="contact_persion">
	          </div>
	     	</div>
	     	...
	     	<div class="col-md-6">
	     	  <div class="form-group">
	        	...
	        	<input type="text" class="form-control" value="{{$model->opening_balance}}" name="opening_balance" id="opening_balance">
	          </div>
			 </div>
