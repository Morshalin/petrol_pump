...
<div class="card border-top-success rounded-top-0" id="table_card">
    ...
    <fieldset class="mb-3" id="form_field">
		<form action="{{route('admin.purchase.update', $model->id)}}" method="post" id="content_form">
            @csrf
            @method('PUT')
			<div id="pay_option">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="company_info_id">{{_lang('Company Name')}}<span class="text-danger">*</span></label>
							<select name="company_info_id" id="company_info_id" class="form-control select">
								<option value="">Select One</option>
								@foreach($company as $data)
								<option {{$model->company_info_id==$data->id?'selected':''}} value="{{$data->id}}">{{$data->company_name}}</option>
								@endforeach
							</select>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="form-group">
							<label for="employess_id">{{_lang('Employee Name')}}<span class="text-danger">*</span></label>
							<select name="employess_id" id="employess_id" class="form-control select">
								<option value="">Select One</option>
								@foreach($employee as $data)
								    <option {{$model->employess_id==$data->id?'selected':''}} value="{{$data->id}}">{{$data->employe_name}}</option>
								@endforeach
							</select>
						</div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="item">
                                @foreach ($model->purchase_line as $key=> $element)
                                    ...
                                    <td>
                                    <input type="number" min="0" name="quantity[]" class="form-control qty" id="qty_{{$key}}" value="{{$element->quantity}}">
                                    </td>
                                    <td>
                                    <input type="number" min="0" name="unit_price[]" class="form-control price" value="{{$element->unit_price}}">
                                    </td>
                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled="disabled" value="{{$model->discount_amount}}" class="form-control"  id="discount_amount" name="discount_amount">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $model->TrxID }}" id="TrxID" name="TrxID"> 
                            </div>
                        </div>
				...
				<div class="text-right">
					<button type="submit" class="btn btn-primary"  id="submit">{{_lang('Purchase Update ')}}<i class="icon-arrow-right14 position-right"></i></button>
...
$("#item").on('keyup', '.qty,.price', function() {
